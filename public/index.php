...
<head>
    ...
    <title>RMQPHP</title>
    <link rel="stylesheet" type="text/css" href="views/src/styles/style.css">
</head>
<body>
    <div class="RMQ-wrapper">
        <div class="RMQ-body">
            ...
            <div class="RMQ-body__app">
                ...
                <div id="RMQ-btnPay" class="RMQ-body__app--pay">Pay <?php echo file_get_contents ("views/src/imgs/cog.svg"); ?></div>
            </div>
            <div class="RMQ-body__footer">Emir Mujic - RMQPHP</div>
        </div>
    </div>
</body>
    <script src="views/src/vendor/jquery/jquery-3.2.1.min.js"></script> 
